...
# KLaOS — expõe labels do contato pra UI listar com cor sem N+1.
# label_list vem do acts_as_taggable (Labelable concern). Array de strings (titles).
# A cor é resolvida no front cruzando com store de account labels.
